...
for(const marker of ['https://web.yummypro.online/#profesionales','location.replace'])if(!landing.includes(marker))throw new Error('index.html: falta redirección a landing unificada '+marker);
...
if(!landing.includes('https://web.yummypro.online/#profesionales'))throw new Error('index.html: debe delegar registro y prueba a la landing unificada');
...
// profesionales-pages-pruebas-routing
for(const m of ['isPagesPruebas','https://jorge2610g.github.io/yummy-restaurante-pruebas/#profesionales','https://web.yummypro.online/#profesionales'])if(!landing.includes(m))throw new Error('index.html: falta redirect seguro profesionales '+m);
